...
import com.thunsaker.brevos.app.BaseBrevosPreferenceActivity;
 ...
 */
public class SettingsActivity extends BaseBrevosPreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    /**
...
//        bindPreferenceSummaryToValue(findPreference("brevos_pref_bitly_connected"));
//        bindPreferenceSummaryToValue(findPreference("brevos_pref_private"));
        bindPreferenceSummaryToValue(findPreference("brevos_bitly_shorten_domain"));
    }
...
//                }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if(key.equals(getString(R.string.prefs_bitly_connected))) {
...
//        if(event.result) {
//            Toast.makeText(mContext, getString(R.string.bitly_connected), Toast.LENGTH_SHORT).show();

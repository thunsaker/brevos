...
//    private void checkDrawOverlayPermission(Bitmark bitmark) {
//        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !Settings.canDrawOverlays(getApplicationContext())) {
//            openPopOverPermission(bitmark);
//        } else {
//            setupView();
...
//    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent.hasExtra(MainActivity.BREVOS_POP_OVER_BITMARK)) {
...
//            checkDrawOverlayPermission(bitmark);
        }
...
//    private void openPopOverPermission(Bitmark bitmark) {
//        Intent permissionIntent = new Intent(getApplicationContext(), PopOverPermission.class);
//        permissionIntent.putExtra(MainActivity.BREVOS_POP_OVER_BITMARK, bitmark.toString());

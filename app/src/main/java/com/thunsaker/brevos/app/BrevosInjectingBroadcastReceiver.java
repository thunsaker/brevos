...
*/
@Deprecated
public class BrevosInjectingBroadcastReceiver
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        mObjectGraph = ((BrevosApp) context.getApplicationContext()).getObjectGraph().plus(getModules().toArray());
    ...
    /**
     * The dagger module associated with {@link com.thunsaker.brevos.app.BrevosInjectingBroadcastReceiver}
     */
    @Module(library = true)
